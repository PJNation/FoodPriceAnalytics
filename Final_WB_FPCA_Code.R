...
ggplot(Avg_WB_FPCA_mze, aes(x = MonthYear)) + 
...
##Counting Complete Data records
...
lm_mze_fgt <- lm(Mean_Monthly_Price ~ Mean_Weekly_Price, data = WB_FPCA_rice_fgt)
summary(lm_mze_fgt)
...
ggplot(Avg_WB_FPCA_rice, aes(x = MonthYear)) + 
